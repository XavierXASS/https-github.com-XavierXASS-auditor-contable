with st.form("form_auditoria", clear_on_submit=False):
    ...
    # ⬇️⬇️⬇️  MUEVE/DEJA ESTE BLOQUE DENTRO DEL 'with st.form(...)'  ⬇️⬇️⬇️
    if submit:
        # Protección: estas variables deben existir (vienen de tu flujo principal)
        # 'id_actual', 'idx', 'fila', 'c_cp', 'pdf_files' ya tienen que estar definidas antes (en tu código lo están).
